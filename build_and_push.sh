#!/bin/bash
# =================================================================
# Emby Telegram Bot Docker Build & Push Script for Shell (Git Bash/WSL)
# @author: hyq
# @version: 2026-06-24
# =================================================================
...
echo -e "\033[36m========== 🚀 Emby TG Bot Docker 构建与推送系统 ==========\033[0m"
...
if [ "$choice" -eq 1 ]; then
    ...
    docker buildx create --use --name tgbot-builder 2>/dev/null || true
