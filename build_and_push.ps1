# =================================================================
# Emby Telegram Bot Docker Build & Push Script for Windows PowerShell
# @author: hyq
# @version: 2026-06-24
# =================================================================

$IMAGE_NAME="fckipk/emby-tgbot"
$TAG="latest"

Write-Host "========== Emby TG Bot Docker Build & Push ==========" -ForegroundColor Cyan
...
if ($choice -eq "1") {
    ...
    docker buildx create --use --name tgbot-builder 2>$null
